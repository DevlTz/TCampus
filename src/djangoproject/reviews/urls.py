...
urlpatterns = [
    ...
    path("professor/<uuid:pk>/avaliacoes/", views.ReviewListProfessorAPIView.as_view(), name="review-list-professor"), 
    path("reviews/", views.ReviewListAPIView.as_view(), name="review-list-all"),
