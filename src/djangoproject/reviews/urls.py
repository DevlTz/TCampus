...
urlpatterns = [
    ...
    path("professor/<uuid:pk>/avaliacoes/", views.ReviewListUniqueAPIView.as_view(), name="review-list"),
    ...
    path('professores/<uuid:pk>/detalhes/', views.TeacherDetailAPIView.as_view(), name='teacher-detail'),
